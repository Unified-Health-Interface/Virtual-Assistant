...
class ActionGetAllUserPrescriptions(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        for prescription in prescriptions:
            response += f"{prescription['id']} - {prescription['doctor']} issued a prescription on {prescription['date_time'].split('T')[0]} to take {prescription['medicines']} everyday at {prescription['date_time'].split('T')[1]}\n"
